...
data = dict(
    ...
    val=dict(
        ...
        lq_folder='data/CelebA-HQ-SR/LQ',
        gt_folder='data/CelebA-HQ-SR/GT',
        ann_file='data/CelebA-HQ-SR/meta_info_CelebAHQ_val100_GT.txt',
    ...
    test=dict(
        ...
        lq_folder='data/CelebA-HQ-SR/LQ',
        gt_folder='data/CelebA-HQ-SR/GT',
        ann_file='data/CelebA-HQ-SR/meta_info_CelebAHQ_test100_GT.txt',
        pipeline=test_pipeline,
        scale=scale))
