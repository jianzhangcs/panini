...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='ffhq_degradation',
            gt_folder='data/FFHQ/images1024x1024',
            ann_file='data/FFHQ/meta_info_FFHQ_GT.txt',
            pipeline=train_pipeline,
            scale=scale)),
    val=dict(
        type=val_dataset_type,
        lq_folder='data/CelebA-HQ-MFR/LQ',
        gt_folder='data/CelebA-HQ-MFR/GT',
        ann_file='data/CelebA-HQ-MFR/meta_info_CelebAHQ_val100_GT.txt',
    ...
    test=dict(
        ...
        lq_folder='data/CelebA-HQ-MFR/LQ',
        gt_folder='data/CelebA-HQ-MFR/GT',
        ann_file='data/CelebA-HQ/meta_info_CelebAHQ_test100_GT.txt',
        pipeline=test_pipeline,
        scale=scale))
